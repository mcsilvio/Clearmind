...
abstract class BaseProfile extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('user_id, emailUpdates', 'numerical', 'integerOnly'=>true),
			array('first_name, last_name', 'length', 'max'=>45),
			array('first_name, last_name, emailUpdates', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, user_id, first_name, last_name, emailUpdates', 'safe', 'on'=>'search'),
		);
	}
