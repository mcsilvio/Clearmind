...
class UserController extends Controller
{
			...
			if($model->validate()){
				...
				if($user === null)
					...
					if($this->emailNewPassword($password, $user))
						...
						$this->render('message', array('title' => 'Password Reset Error', 'message' => 'An error has occurred while resetting your password. Please inform support@funisher.com'));
				}
			}
			else
	...
	public function emailNewPassword($password, $user){
		...
		$message = 	'
				...
				<p>Thank you for using Funisher.com.</p>
	...
	public function sendRegistrationEmail($user){
		...
		$message = 	'
				...
				<p>Thank you for registering an account with Funisher.com.</p>
	...
	public function actionActivate(){
		...
		if($user === null)
			$this->render('message', array('title' => 'Error', 'message' => 'The emailed link is wrong. Please contact info@funisher.com'));
