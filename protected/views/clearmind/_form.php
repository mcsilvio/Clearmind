...
<div id="ajax-form" class='form'>
    ...
    <fieldset>
        ...
        <div class="control-group">
            <?php echo $form->labelEx($model, 'node_title', array('class' => 'control-label')); ?>
            <div class="controls">
                <?php echo $form->textField($model, 'node_title', array('value'=>$_POST['node_title'],'class' => 'span4', 'size' => 60, 'maxlength' => 128)); ?>
                <p class="help-block"><?php echo $form->error($model, 'node_title'); ?></p>
            </div>
        </div>

        <div class="control-group">
            <?php echo $form->labelEx($model, 'node_content', array('class' => 'control-label')); ?>
            <div class="controls">
                <?php echo $form->textArea($model, 'node_content', array('class' => 'span4', 'rows' => 5, 'cols' => 50)); ?>
                <p class="help-block"><?php echo $form->error($model, 'node_content'); ?></p>
            </div>
        </div>
